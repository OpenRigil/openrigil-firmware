...
#define USB_INTERRUPT_ENABLE                  (USB_BASE + 0x0C)
#define USB_INTERRUPT_ENABLE_RESET_BIT_MASK   (1 << 0)
#define USB_INTERRUPT_ENABLE_RX_BIT_MASK      (1 << 1)
#define USB_INTERRUPT_ENABLE_TX_BASE_BIT_MASK (1 << 2)
#define USB_INTERRUPT_ENABLE_TX_BIT_MASK(ep)  (USB_INTERRUPT_ENABLE_TX_BASE_BIT_MASK << (ep))
